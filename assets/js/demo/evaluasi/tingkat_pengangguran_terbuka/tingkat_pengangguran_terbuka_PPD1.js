    var main = function(){
        controller = "index.php/Tingkat_pengangguran_terbuka";
...
//                            },
                       ...
                       $('form#form_pe_perk p[name="rad_kab"]').html(obj.perbandingan_radar);
                       $('form#form_pe_perk p[name="per_kab"]').html(obj.perbandingan_kab);
