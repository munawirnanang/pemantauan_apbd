var main = function(){
    controller = "index.php/E_indeks_pembangunan_manusia";
    var datatable = function(){
        ...
        function satu(){
            ...
            jQuery.ajax({
                ...
                var rad = Highcharts.chart('container-1-rad', {
                    chart: { 
                        polar: true,
                        type: "line",
                        marginTop: 10,
...
//                            }
                   ...
                   $('form#form_ch p[name="per_pro"]').html(obj.pe_perbandingan_pro);
                   $('form#form_pe_p p[name="per_p"]').html(obj.perbandingan_2th);
                   $('form#form_pe_kab p[name="per_kab"]').html(obj.pe_perbandingan_kab);
