        ...
        jQuery.ajax({
            ...
            success:function(response){
                ...
                for (let index = 0; index < 1; index++) {
                    ...
                    html_grafik += '<div class="card" style="border: 1px solid black; border-radius: 10px; height: 800px;">';
                    html_grafik += '<div class="card-header" style="border-radius: 10px; padding-top: 5px; padding-bottom: 0px; text-align: left;">';
                    html_grafik += '</div>';
                    html_grafik += '<div class="card-body" style="padding-top: 5px;">';
                    html_grafik += '<figure class="highcharts-figure">';
                    html_grafik += '<div id="container-'+index+'"></div>';
                    html_grafik += '</figure>';
                    html_grafik += '</div>';
                    html_grafik += '</div>';
                    html_grafik += '</div>';
