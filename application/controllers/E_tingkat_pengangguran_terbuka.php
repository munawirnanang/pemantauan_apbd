...
class E_tingkat_pengangguran_terbuka extends CI_Controller {
            ...
            try {
                ...
                if($pro == '' && $rpjmn=='' ){
                    ...
                    foreach ($list_ppe_per->result() as $row_ppe_per) {
                        ...
                        $nilai_p_e_r1[$row_ppe_per->label]         = $row_ppe_per->nilai;
                        $nilai_p_e_r2[$row_ppe_per->nama_provinsi] = $row_ppe_per->nilai;
                        $thn_p         = $bulan[$row_ppe_per->periode]." ".$row_ppe_per->tahun; 
                    }                    
                    $label_ppe1          = $label_ppe;
                    $nilaiData_p['name'] = $thn_p;
                    ...
                    $pe_perbandingan_pro = "Perbandingan tingkat pengangguran terbuka antar 34 provinsi menunjukkan bahwa tingkat pengangguran terbuka ". $xname ." 
                        pada ".$tahun_tk_p_max." berada pada urutan ke-".$rengking_pro.".
                           Provinsi dengan tingkat pengangguran terbuka tertinggi adalah ".array_shift($nama_pe2)." (".$nilai_ppe_p_max."%),
                    ...
                    $pe_perbandingan_radar = "Perbandingan tingkat pengangguran terbuka ".$categories[3]." dengan ".$categories[5]." menunjukkan bahwa 
                        provinsi yang mengalami penurunan tingkat pengangguran terbuka terbesar adalah ".$label_tk_per_p_max." (".number_format($nilai_tk_per_p_min,2,",",".")."%). 
                        Dari sisi perubahan tingkat pengangguran terbuka periode ".$categories[3]." hingga ".$categories[5].", ". $xname ." berada pada urutan ke-".$rengkingtk_p.", dengan tingkat pengangguran terbuka ".$nu_p." sebesar ".number_format($nper_tk,2,",",".")."%";
                   ...
                   $pe_perbandingan_kabb="Perbandingan tingkat pengangguran terbuka antar kabupaten/kota di ". $xname ." memperlihatkan bahwa pada periode ".$tahun_p_k." daerah dengan tingkat tingkat pengangguran terbuka tertinggi adalah ".array_shift($nama_k2)." (".number_format($nilai_ppe_per_kab_max,2,",",".")."%), sedangkan daerah dengan tingkat pengangguran terbuka terendah adalah ".end($nama_k2)." (".number_format($nilai_ppe_per_kab_min,2,",",".")."%).
