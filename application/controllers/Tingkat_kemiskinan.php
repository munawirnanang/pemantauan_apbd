...
class Tingkat_kemiskinan extends CI_Controller {
                    ...
                    $thnmax ="SELECT * FROM (
                                                ...
                                                WHERE (id_indikator='36' AND wilayah='1000') 
                                                        AND (id_periode) IN (
                                                                ...
                                                                FROM nilai_indikator WHERE id_indikator='36' AND wilayah='1000' 
                                                                ) 
                                                GROUP BY id_periode 
                    ...
                    foreach ($list_ppe_per->result() as $row_ppe_per) {
                       ...
                       $type1[] = [
                           ...
                           "properties"  =>array(
                               ...
                               "description" => '<strong>'.$row_ppe_per->nama_provinsi.' - Periode : '.$thn_a.'</strong><p> Tingkat Kemiskinan : '.$row_ppe_per->nilai.' %</p>',
                               ),
                           ];
                       $nilai_peta = $type1;
                    }
                    ...
                    //nasional                        
                     $thnmax ="SELECT * FROM (
                                ...
                                WHERE (id_indikator='36' AND wilayah='".$query."') 
                                        AND (id_periode) IN (
                                                SELECT  MAX(id_periode) AS id_periode 
                                                FROM nilai_indikator WHERE id_indikator='36' AND wilayah='".$query."' 
                                                ) 
                                GROUP BY id_periode 
                        ORDER BY id_periode DESC LIMIT 6) Y 
                        ORDER BY id_periode ASC ";
                    ...
                    foreach ($list_kab_ppe_per->result() as $row_ppe_kab_per) {
                        ...
                        $type[] = ["type"        => "MultiPolygon",
                                        ...
                                        "properties"  =>array("ID"   =>$no++,
                                                              ...
                                                              "description"=>
                                                            '<strong>'.$label_ppe11.'</strong></Br> Periode : '.$periode_kab.' </Br><p> Tingkat Kemiskinan : '.$row_ppe_kab_per->nilai.' %</p>',
                                         ),
                                        ];
                       $nilai_peta = $type;
                    }
...
//                    }
                   ...
                   $pe_perbandingan_kabb="Perbandingan tingkat kemiskinan antar kabupaten/kota di ". $xname ." memperlihatkan 
