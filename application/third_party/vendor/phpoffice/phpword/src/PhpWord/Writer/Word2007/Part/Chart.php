...
class Chart extends AbstractPart
{
    ...
    public function write()
    {
        ...
        Source  : https://github.com/PHPOffice/PHPWord/pull/1699/files and https://www.youtube.com/watch?v=ALRUgrf3usE
        change  : add <c:roundedCorners val="1"/><c:style val="2"/>
        */

        //-----------------------------------------------------------------------------------------------------------

        $xmlWriter->writeRaw('<c:roundedCorners val="1"/><c:style val="2"/>'); 
    ...
    private function writePlotArea(XMLWriter $xmlWriter)
    {
        ...
        if ($showLegend) {
            ...
            Date    : 2 - February - 2021
            Source  : https://github.com/PHPOffice/PHPWord/pull/1699/files and https://www.youtube.com/watch?v=ALRUgrf3usE
            change  : <c:legendPos val="r"/> to <c:legendPos val="b"/> and add <c:overlay val="0"/>
             */

            $xmlWriter->writeRaw('<c:legend><c:legendPos val="b"/><c:overlay val="0"/></c:legend>');
        }
