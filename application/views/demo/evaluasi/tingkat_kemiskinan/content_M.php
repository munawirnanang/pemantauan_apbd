<div class="row">
    <div class="col-12">
        ...
        <div class="page-title-box">
            <h4 class="page-title ml-3">Tingkat Kemiskinan </h4>
            <ol class="breadcrumb p-0 m-0 mr-3">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Tingkat Kemiskinan</b></li>
            </ol>
                    ...
                    <form class="form-inline">
                        <div class="input-group">
                            ...
                            <div class="form-group ml-2 bg-success btnMenu" data-target="<?php echo site_url("Gis")?>">
                                <button type="button" class="btn btn-primary waves-effect waves-light " ><i class="fas fa-arrow-left"></i>&nbsp;Kembali</button>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-5">
            <div class="card" style="height: 405px;">
                ...
                <div class="card-body overflow-auto" style="text-align: justify;">
                    ...
                    <!-- <form id="form_pe_perk" style="display: hidden;">
                        <p name="rad_kab""></p><br/>
                        <p name="per_kab"></p>
                    </form> -->
                </div>
