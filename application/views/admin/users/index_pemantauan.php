<div class="container-fluid">
    <div class="row" id="tab-search-user-pemantauan" style="background-color: white; margin-bottom: 20px; margin-left: -39px; margin-right: 0px; position: fixed; z-index: 99; width: -webkit-fill-available; border-bottom: 2px solid #B8A5A5;">
        <div class="col-lg-12">
            <div class="page-title-box" style="padding-bottom: 0px; margin-left: 0px; margin-right: 0px;">
                ...
                <div class="card card-fill" style="border: 1px solid #000000; border-radius: 20px; display: inline-block; background-color: white">
                    <h4 class="card-title text-black" style="font-family: 'Montserrat', sans-serif; padding: 0.5rem 0.75rem;">Tim Pemantauan</h4>
                </div>
                <ol class="breadcrumb p-0 m-0" style="margin-top: 5px !important;">
                    ...
                    <li class="breadcrumb-item active" style="color: black;">Tim Pemantauan</li>
                </ol>
            </div>
        </div>
    </div>
