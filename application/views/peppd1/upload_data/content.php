<div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="page-title-box" style="padding-bottom: 0px; margin-left: 0px; margin-right: 0px;">
                ...
                <div class="card card-fill" style="border: 1px solid #000000; border-radius: 20px; display: inline-block; background-color: white">
                    <h4 class="card-title text-black" style="font-family: 'Montserrat', sans-serif; padding: 0.5rem 0.75rem;">Upload Data Indikator</h4>
                </div>
    ...
    <!-- <div class="row">
        <div class="col-lg-12" style="margin-top: 90px; text-align: right;">
            <a href="https://peppd.bappenas.go.id/pemantauan/attachments/contohtemplate/contoh_template.xlsx" target='_blank' class="btn btn-primary mb-1 mr-1"><i class="fa fa-download" aria-hidden="true"></i> Download File Template Indikator</a>
            <a href="https://peppd.bappenas.go.id/pemantauan/attachments/contohtemplate/contoh_Struktur_dan_Pertumbuhan_PDRB_Sektoral.xlsx" target='_blank' class="btn btn-primary mb-1 mr-1"><i class="fa fa-download" aria-hidden="true"></i> Download File Template Struktur & Pertumbuhan PDRB Sektoral</a>
        </div>
    </div> -->
