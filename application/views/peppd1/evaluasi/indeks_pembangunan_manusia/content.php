                    ...
                    <div class="p-1 bg-primary rounded rounded-pill shadow-sm mb-4">
                        <div class="form-group">
                            ...
                            <span class="input-group-prepend">
                                <button type="button" class="btn waves-effect waves-light btn-primary border-0 plhpro" title="klik untuk melihat list provinsi" style="border-radius: 20px; width: 300px; text-align: left;">
                                    <p id="inp_pro_text" style="position: absolute; margin: -2px;">Nasional</p><i class="fa fa-search" style="float: right; padding: 3px;"></i>
                                </button>
                            </span>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card card-box" style="border: 2px solid black;">
                        <div class="card-body">
                            ...
                            <form id="form_ch">
                                <p style="margin-left: 1rem; margin-right: 1rem;" name="maxpep"></p>
                            </form>
                        </div>
                    </div>
                </div>
