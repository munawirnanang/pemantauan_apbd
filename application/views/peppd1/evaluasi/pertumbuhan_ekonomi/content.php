<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title ml-3"><img class="chart-icon" src="<?php echo base_url("assets/images/chart-line-icon.png")?>"> Pertumbuhan Ekonomi</h4>
            ...
            <div class="tab-pane fade show active" id="nav-graph" role="tabpanel" aria-labelledby="nav-graph-tab">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12" style="display: none; padding: 0px;" id="pe_pro">
                    <div class="card card-box" id="pe_pro" style="border: 2px solid black;">
                            ...
                            <div class="card-body " style="">
                                <form id="form_pe" > <p style=" margin-left: 1rem; margin-right: 1rem;" name="per_pro"></p><br/> </form>
                            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-12" style="display: none; padding: 0px;" id="pe_rad">
                    <div class="card card-box" style="border: 2px solid black;">
                        <div class="card-body" >
                                        <div id="chart-container-rad" style="height: 340px;"></div>
                        </div>
                        <div class="card-body " style="">
                            <form id="form_pe_p" > <p style=" margin-left: 1rem; margin-right: 1rem;" name="per_p"></p><br/> </form>
                        </div>
                    </div>
                </div>
