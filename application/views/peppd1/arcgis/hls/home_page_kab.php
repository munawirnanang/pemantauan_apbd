  ...
  <body>
    ...
    <script>
      ...
      var dynamic_indonesia_map = L.esri
        .dynamicMapLayer({
          url: "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_Harapan_Lama_Sekolah_KabupatenKota/MapServer",
          opacity: 0.7,
        })
        .addTo(map);
      ...
      var feature_indonesia_map = L.esri
        .featureLayer({
          url: "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_Harapan_Lama_Sekolah_KabupatenKota/FeatureServer/0",
          simplifyFactor: 0.35,
          precision: 5,
      ...
      feature_indonesia_map.bindPopup(function (layer) {
        // console.log(layer);
        return (
          "<strong>Harapan Lama Sekolah</strong><hr />" +
          ...
          "</strong></span><br />" +
          "<span>Capaian : <strong>" +
          layer.feature.properties.hls_2020 +
          "</strong></span><br />" +
    ...
    <script>
      ...
      $.getJSON(
        "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_Harapan_Lama_Sekolah_KabupatenKota/MapServer/legend?f=pjson",
        function (data) {
    ...
    <script>
      ...
      $.getJSON(
        "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_Harapan_Lama_Sekolah_KabupatenKota/FeatureServer?f=pjson",
        function (data) {
