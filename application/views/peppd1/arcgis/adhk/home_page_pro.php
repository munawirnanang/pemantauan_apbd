  ...
  <body>
    ...
    <script>
      ...
      var dynamic_indonesia_map = L.esri
        .dynamicMapLayer({
          url: "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_ADHK_per_Kapita_Provinsi/MapServer",
          opacity: 0.7,
        })
        .addTo(map);
      ...
      var feature_indonesia_map = L.esri
        .featureLayer({
          url: "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_ADHK_per_Kapita_Provinsi/FeatureServer/0",
          simplifyFactor: 0.35,
          precision: 5,
    ...
    <script>
      ...
      $.getJSON(
        "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_ADHK_per_Kapita_Provinsi/MapServer/legend?f=pjson",
        function (data) {
    ...
    <script>
      ...
      $.getJSON(
        "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_ADHK_per_Kapita_Provinsi/FeatureServer?f=pjson",
        function (data) {
