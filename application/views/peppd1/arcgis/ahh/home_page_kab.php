  ...
  <body>
    ...
    <script>
      ...
      feature_indonesia_map.bindPopup(function (layer) {
        // console.log(layer);
        return (
          "<strong>Angka Harapan Hidup</strong><hr />" +
    ...
    <script>
      ...
      $.getJSON(
        "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_Angka_Harapan_Hidup_KabupatenKota/FeatureServer?f=pjson",
        function (data) {
