  ...
  <body>
      ...
      <!-- <div class="col-sm-4 p-1">
        <div class="row">
          <div class="col-6 pr-1">
            <div
              ...
              style="background-color: #33b86c; height: 170px"
            >
              <div class="card-body text-light p-2">
                <h6>Jumlah Kabupaten / Kota</h6>
                <h1 id="jumlah_kab_kota"></h1>
        ...
        <div class="row">
          <div class="col-12">
            <div
              class="card border-dark mb-2"
              style="background-color: #33b86c; height: 370px;"
            >
            ...
            >
              <div class="card-body p-1">
                <h4 class="text-white d-flex justify-content-center">
                  ...
                  ></i>
                  <a class="text-white" href="" onclick="window.close()"
                    >KEMBALI</a
                  >
                </h4>
              </div>
      ...
      <div class="col-sm-4 p-1">
        ...
        <div class="row">
          <div class="col-12">
            <div
              class="card border-dark mb-2"
              style="background-color: #33b86c; height: 340px;"
            >
              <div class="card-header text-light p-2" style="border-bottom: 1px solid #f8f9fa;">
    ...
    <script>
      ...
      var dynamic_indonesia_map = L.esri
        .dynamicMapLayer({
          url: "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_ADHB_per_Kapita_KabupatenKota/MapServer",
          opacity: 0.7,
        })
        .addTo(map);
      ...
      var feature_indonesia_map = L.esri
        .featureLayer({
          url: "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_ADHB_per_Kapita_KabupatenKota/FeatureServer/0",
          simplifyFactor: 0.35,
          precision: 5,
      ...
      feature_indonesia_map.bindPopup(function (layer) {
        // console.log(layer);
        return (
          "<strong>ADHB Per Kapita</strong><hr />" +
          ...
          "</strong></span><br />" +
          "<span>Capaian : <strong>" +
          layer.feature.properties.adhb_2020 +
          "</strong></span><br />" +
    ...
    <script>
      ...
      $.getJSON(
        "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_ADHB_per_Kapita_KabupatenKota/MapServer/legend?f=pjson",
        function (data) {
    ...
    <script>
      ...
      $.getJSON(
        "https://geospasial.bappenas.go.id/server/rest/services/Produksi/PEPPD_ADHB_per_Kapita_KabupatenKota/FeatureServer?f=pjson",
        function (data) {
